      ...
      <Container>
        ...
        <Row>
          <Col sm={12} md={12} xl={5}>
            ...
            <p className='btn-title text-center'>Bee's are always Busy<br/></p>
            <img className='image-radius img-fluid' src={require('../../Assets/Beetasks.png')} alt="Logo" width={350}/>
          ...
          <Col xl={5}>
            ...
            <p className='btn-title text-center'>Looking forward to complete these tasks:</p>
          </Col>
        </Row>
      </Container>
    </div>
